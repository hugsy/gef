...
class TestGefCommandsUnit(GefUnitTestGeneric):
    ...
    def test_cmd_keystone_assemble(self):
        valid_cmds = [
            ...
            "assemble --arch arm   --mode arm     --big-endian add  r0, r1, r2",
            "assemble --arch arm   --mode thumb                add  r0, r1, r2",
            "assemble --arch arm   --mode thumb   --big-endian add  r0, r1, r2",
            "assemble --arch arm   --mode armv8                add  r0, r1, r2",
            "assemble --arch arm   --mode armv8   --big-endian add  r0, r1, r2",
            "assemble --arch arm   --mode thumbv8              add  r0, r1, r2",
            "assemble --arch arm   --mode thumbv8 --big-endian add  r0, r1, r2",
            "assemble --arch arm64 --mode aarch64 add x29, sp, 0; mov  w0, 0; ret",
            "assemble --arch mips  --mode mips32               add $v0, 1",
            "assemble --arch mips  --mode mips32  --big-endian add $v0, 1",
            "assemble --arch mips  --mode mips64               add $v0, 1",
            "assemble --arch mips  --mode mips64  --big-endian add $v0, 1",
            "assemble --arch ppc   --mode ppc32   --big-endian ori 0, 0, 0",
            "assemble --arch ppc   --mode ppc64                ori 0, 0, 0",
            "assemble --arch ppc   --mode ppc64   --big-endian ori 0, 0, 0",
            "assemble --arch sparc --mode sparc32              set 0, %o0",
            "assemble --arch sparc --mode sparc32 --big-endian set 0, %o0",
            "assemble --arch sparc --mode sparc64 --big-endian set 0, %o0",
